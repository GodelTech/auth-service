...
from src.data_access.postgresql.tables import Role, User, UserClaim
...
class UserRepository(BaseRepository):
    ...
    async def get_claims(self, id: int) -> Dict[str, str]:
    ...
    async def request_DB_for_claims(self, id: int) -> List[UserClaim]:
        session_factory = sessionmaker(
            self.engine, expire_on_commit=False, class_=AsyncSession
        )
        async with session_factory() as sess:
