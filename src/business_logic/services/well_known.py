...
class WellKnownServies():
    ...
    async def get_openid_configuration(self,) -> dict:
        ...
        result["id_token_signing_alg_values_supported"] = self.get_list_of_types()
        ...
        result["request_object_signing_alg_values_supported"] = self.get_list_of_types()
        result["userinfo_encryption_enc_values_supported"] = self.get_list_of_types()
        result["userinfo_encryption_alg_values_supported"] = self.get_list_of_types()
        result["userinfo_signing_alg_values_supported"] = self.get_list_of_types()
        result["id_token_encryption_enc_values_supported"] = self.get_list_of_types()
        result["id_token_encryption_alg_values_supported"] = self.get_list_of_types()
