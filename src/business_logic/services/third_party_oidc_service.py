...
class ThirdPartyGoogleService(AuthThirdPartyOIDCService):
    async def get_google_redirect_uri(self) -> Optional[str]:
        links = await self.get_provider_external_links(name="google")
        access_token_url: str = ""
        user_data_url: str = ""
...
class ThirdPartyFacebookService(AuthThirdPartyOIDCService):
    async def get_facebook_redirect_uri(self) -> Optional[str]:
        facebook_links = await self.get_provider_external_links(name="facebook")
        access_token_url: str = ""
        user_data_url: str = ""
