...
class LinkedinAuthService(ThirdPartyAuthMixin):
    """
    Service class for handling authentication with LinkedIn as a third-party provider.

    This class implements the necessary methods and functionality to authenticate users
    using LinkedIn's OAuth 2.0 flow.
    ...
    def __init__(
        ...
        """
        Initialize a new instance of LinkedinAuthService.
    ...
    async def get_redirect_url(
        ...
        """
        Generates the redirect URL for the LinkedIn authentication flow.
        ...
        Raises:
            ...
            ThirdPartyAuthProviderInvalidRequestDataError: If the request to Linkedin returns an error response.
        """
