...
class UnsupportedGrantTypeResponse(ErrorResponseBase):
    ...
    Args:
        detail (any, optional): Additional iFnformation about the error. Defaults
            to the value generated by 'get_error_response_detail' method.
    """
...
class UnsupportedResponseTypeRespons(ErrorResponseBase):
    """
    ...
    # TODO: error_desc could also list all supported response types. Is this a good idea?
    detail = ErrorResponseBase.get_error_response_detail(
        error="unsupported_response_type",
        error_desc="The response type requested is not supported by the authorization server.",
    )
...
class UserNotFoundResponse(ErrorResponseBase):
    ...
    detail = ErrorResponseBase.get_error_response_detail(
        error="invalid_grant",
        error_desc="The user is not found or is invalid. Check your username.",
    )
...
class ClientRedirectUriErrorResponse(ErrorResponseBase):
    ...
    detail = ErrorResponseBase.get_error_response_detail(
        error="invalid_request",
        error_desc="The client redirect_uri could not be found in the database.",
    )
...
class UserCodeNotFoundErrorResponse(ErrorResponseBase):
    """Response class used when the could not be found in the database.
    ...
    detail = ErrorResponseBase.get_error_response_detail(
        error="invalid_request",
        error_desc="The client user code could not be found in the database.",
    )
