...
async def get_authorize(
    ...
    try:
        ...
        response = RedirectResponse(firmed_redirect_uri, status_code=status.HTTP_302_FOUND)
        ...
        return JSONResponse(
            status_code=status.HTTP_404_NOT_FOUND,
            content={"message": "The scope is missing a password, or a username"}
        )
...
@auth_router.post('/', status_code=status.HTTP_302_FOUND, tags=['Authorization'])
