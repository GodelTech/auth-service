...
async def get_all_users(
    ...
    user_class = user_class
    return {
        "all_users":await user_class.get_all_users(group_id=request_model.group_id, role_id=request_model.role_id)
    }
...
async def update_user(
    ...
    await user_class.update_user(user_id = request_model.user_id, kwargs=data_to_change)
...
async def add_roles(
    ...
    user_class = user_class
    await user_class.add_user_roles(user_id = request_model.user_id, role_ids=request_model.role_ids)
    return
...
async def get_user_groups(
    ...
    return {
        "groups": await user_class.get_user_groups(user_id = request_model.user_id)
        }
...
async def delete_roles(
    ...
    await user_class.remove_user_roles(user_id = request_model.user_id, role_ids=request_model.role_ids)
...
async def delete_groups(
    ...
    await user_class.remove_user_groups(user_id = request_model.user_id, group_ids=request_model.group_ids)
