...
class TestClientRepository:
    ...
    async def test_validate_client_redirect_uri(self, connection: AsyncSession) -> None:
        client_repo = ClientRepository(connection)
    ...
    async def test_validate_client_redirect_uri_error(self, connection: AsyncSession) -> None:
        client_repo = ClientRepository(connection)
