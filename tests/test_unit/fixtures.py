...
TEST_VALIDATE_PASSWORD = [
    ('test_password', '$2b$12$rNqlpYZ51ilkRAr5uH5SfOAPUeQUrnclub8r3XNTQh6pS7lBqXnEi'),
    ('abra_vadaBra', '$2b$12$dszlwCsMRY29mNuIAgMrEuZt412OslAl3KN8m95Ze.X7eCYnexoce'),
    ('fhfy$%_mkLKvbh67eT', '$2b$12$4dyIxC1keM0taJ6wetY8JOIAW2UOZNYT.Vhz5YoVPnpeqSo.pOmsO'),
...
DEFAULT_USER_CLAIMS = [
    {
        'User': 1,
        'claim_type': 'given_name',
        'claim_value': 'Tony'
    },
    {
        'User': 1,
        'claim_type': 'family_name',
        'claim_value': 'Stark'
    },
    {
        'User': 1,
